...
const RECIPE_DATA = {
	Enum.Item.DODOL: {
			...
			'ingredients': {
					Enum.Item.PANDAN: 1,
					Enum.Item.RICE_FLOUR: 1,
					Enum.Item.PALM_SUGAR:1,
					Enum.Item.COCONUT_MILK: 1,
		}	
	},
	Enum.Item.PALAPA: {
		'name': 'Palapa',
		'ingredients': {
			Enum.Item.SCALLION: 1,
			Enum.Item.GINGER: 1,
			Enum.Item.CHILI: 1
		}	
	}	
...
var items = {
	...
	Enum.Item.PUMPKIN: 7,
	Enum.Item.TOMATO: 4,
	Enum.Item.FISH_STEW: 0,
	Enum.Item.CORNBREAD: 0,
	Enum.Item.TOMATO_SOUP: 0,
	Enum.Item.PUMPKIN_PIE: 0,
	Enum.Item.BAKED_APPLE: 0,
	Enum.Item.PANDAN: 0,
	Enum.Item.RICE_FLOUR: 10,
	Enum.Item.PALM_SUGAR: 10,
	Enum.Item.COCONUT_MILK: 10,
	Enum.Item.DODOL: 0,
	Enum.Item.GINGER: 10,
	Enum.Item.CHILI: 10,
	Enum.Item.SCALLION: 10,
	Enum.Item.PALAPA: 0}
...
func _input(event):
	if event.is_action_pressed("cook_book"):
		cookbook_toggled.emit()
